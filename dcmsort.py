...
e.g. StudyDate.StudyTime-PatientName/SeriesNumber-Modality-SeriesDescription"
"""
...
def main():
    ...
    parser.add_argument("i", help="list of input directories to search for "
                                  "DICOM files", nargs='+', type=pathlib.Path)
    ...
    utils.check_script_ver(script_fp, args.any_version)

    utils.check_lib_ver('pydicom', pydicom.__version__,
                        PYDICOM_VERSIONS, args.any_version)
